...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.atguigu.com/"><img clstag="clickcart|keycount|xincart|logo" src="/mycart/images/reglogo.png" title="返回尚商商城首页" alt="返回尚商商城首页"></a></div>
...
<div class="w cart">
	<div class="cart-hd group">
		<h2>我的购物车</h2>
		<span id="show2" class="fore"> <span>现在&nbsp;</span><a class="btn" href="javascript:goToLogin();"><span class="btn-text">登录</span></a><span>， 您购物车中的商品将被永久保存</span> </span>	</div>
	<div id="show">
...
<div class="cart-inner">
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
        	<c:set var="totalPrice"  value="${ totalPrice + (cart.productPrice * cart.num)}"/>
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://www.atguigu.com/product/${cart.productId }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.productImage}" alt="${cart.productTitle}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="http://product.atguigu.com/product/${cart.productId }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.productTitle}</a>
		                	<span class="promise411 promise411_11345721" id="promise411_11345721"></span>
		                </div>    
		            </div>
		            <div class="cell p-price"><span class="price">¥<fmt:formatNumber groupingUsed="false" value="${cart.productPrice / 100}" maxFractionDigits="2" minFractionDigits="2"/> </span></div>
		            ...
		            <div class="cell p-quantity" for-stock="for-stock-11345721">
		                <div class="quantity-form" data-bind="">
		                    ...
		                    <input type="text" class="quantity-text" itemPrice="${cart.productPrice}" itemId="${cart.productId}" value="${cart.num }" id="changeQuantity-11345721-1-1-0">
		                    <a href="javascript:void(0);" class="increment" clstag="clickcart|keycount|xincart|add1" id="increment">+</a>
		                </div>
		            </div>
		            <div class="cell p-remove"><a id="remove-11345721-1" data-more="removed-87.20-1" clstag="clickcart|keycount|xincart|btndel318558" class="cart-remove" href="/cart/delete/${cart.productId}.html">删除</a>
		            </div>
		        </div>
	        </div> 
        </c:forEach>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  <b>                  </b>
                  <a href="http://www.atguigu.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>              </span>          </div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          ...
                          <a href="javascript:goToOrder();" class="checkout-jd">去京东结算<b></b></a>                      </span>                  </span>              </div>
              <div class="total fr">
                  总计（不含运费）：
                  <span class="totalSkuPrice">¥<fmt:formatNumber value="${totalPrice / 100}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></span>              </div>
          </div>
      </div>
        </div>
</div><!-- cart-inner结束 -->
